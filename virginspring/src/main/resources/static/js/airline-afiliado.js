jQuery(document).ready(function () {
    ...
    $(".airline-element-lookflights").click(function () {
        ...
        /*Lo que se muestra*/
        $("#airlines-selector").css("width","3em");
        $("#flight-selector").show();
        $("#container-page").attr("src","vuelo-defecto/");

        $.ajax({
            url: '/partner/obtener-vuelos',
            type: 'GET',
            data: {
                ...
                if (data.length != 0){
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var newOption = $('<div class="flight-element">\n' +
                            ...
                            '                    <div class="flight-element-available"> <input type="checkbox" value="'+ data[i].flightNumber + '"' + state +'/></div>\n' +
                            '                </div>');
                    ...
                    $(".flight-element-name").click(function () {
                        ...
                        /**$("#container-page").attr("src","horarios?idVuelo="+ flightNumber +"&initials="+airlineInitials);*/
                    });
    ...
    $("#airlines-footer").click(function () {
        $("#container-page").attr("src","/partner/agregar-aerolinea/");
    });

    $("#flights-footer").click(function () {
        $("#container-page").attr("src","/partner/vuelos/agregar?initials="+ airlineObjectSelected.siblings().attr("value"));
    });
